...
class SeqGenerators:
    ...
    def __init__(self, datasets_dir: str, dataset: str, input_steps: int, batch_size: int, split: tuple, max_samples: int = 10000):
        ...
        self.train_split, self.valid_split, self.test_split = split

        self._prepare_index_mapper(max_samples)

    def _prepare_index_mapper(self, max_samples):
        different_samples = (len(self.data) - (self.output_steps + self.input_steps - 1))
...
class Seq2SeqGenerators(SeqGenerators):
    def __init__(self, datasets_dir: str, dataset: str, input_steps: int, output_steps: int,
                 batch_size: int, split: tuple, max_samples: int = 10000):
